...
5eveNk3o1ME@VAJAS - Sparrow of the wind';
	...
	function widget_daikos_youtube($args, $number = 1) {
		$dytwVersion = "Daiko's YouTube Widget v. 1.0 beta";
		extract($args);
...
/* Do the conditional tag checks. */
	...
	function widget_daikos_youtube_head() {
   			 ?>
<link rel="stylesheet" href="<?php bloginfo('url'); ?>/wp-content/plugins/DYTW/dytw.css" type="text/css" media="screen" />
<script type="text/javascript" src="<?php bloginfo('url'); ?>/wp-content/plugins/DYTW/js/swfobject.js"></script>			
				 <?php
	}
