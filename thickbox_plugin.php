...
function daikos_thickbox() {
	...
	echo("<script type='text/javascript' src='".$thickbox_path."thickbox-compressed.js'></script>"); // The ThickBox script is made no-conflict ready by replacing $ with  jQuery throughout the script otherwise standard ThickBox 3.1
